...
console.log('zeit', zeit) // Zeit {_date: Wed Nov 16 2016 16:08:50 GMT+0800 (MYT)}
console.log('zeit.value', zeit.value) // Wed Nov 16 2016 16:08:50 GMT+0800 (MYT)
...
console.log('zeit.isThisWeek', zeit.isThisWeek) // true
    ...
    console.log('zeit.yearCount', zeit.yearCount) // 366
